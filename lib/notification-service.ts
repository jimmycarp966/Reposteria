...
/**
 * Envía notificaciones push a todos los usuarios suscritos
 */
export async function sendPushNotification(notification: NotificationData): Promise<{ success: boolean; message: string }> {
  try {
